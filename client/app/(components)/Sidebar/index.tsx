...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col ${isSidebarCollapsed ? "w-0 md:w-16" : "w-72 md:w-64"} bg-white transition-all duration-300 overflow-hidden shadow-md h-full z-40`;
    ...
    <div className={sidebarClassNames}>
      {/* Top Logo */}
        ...
        <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
          <p className='text-center text-sm text-gray-500'>&copy;2025 EStock</p>
        </div>
    </div>
